...
rem (C)2015
echo Welcome to EasySale Mobile!
:m
cls
...
cls
echo The total is listed on receipt.          
echo Please count the received money.
echo Enter paid amount below.
echo -=-=-=-=-=-=-=-=-   
echo EASYSALE RECEIPT            
echo %date%, %time%             
echo %item1% -=-=-=-=-=-=-=- %price1%   
echo %item2% -=-=-=-=-=-=-=- %price2%   
echo %item3% -=-=-=-=-=-=-=- %price3%   
...
echo Change is listed in its column.
echo -=-=-=-=-=-=-=-=-
echo EASYSALE RECEIPT            
echo %date%, %time%             
echo %item1% -=-=-=-=-=-=-=- %price1%   
